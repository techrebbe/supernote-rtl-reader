...
v0.0.102 also moves trail JSON serialization and fingerprint hashing to that
...
RTL Reader v0.4.12 or newer and Native Spread v0.0.102 or newer are required for
