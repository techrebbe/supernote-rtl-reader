...
v0.0.101 also moves trail JSON serialization and fingerprint hashing to that
...
completed snapshot, rather than attributing an older hash to a new save.
...
RTL Reader v0.4.12 or newer and Native Spread v0.0.101 or newer are required for
