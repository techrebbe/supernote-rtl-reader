...
v0.0.113 also moves trail JSON serialization and fingerprint hashing to that
...
Diagnostic events run before the last re-stat so successful paths perform no
logging work between final source verification and acceptance.
...
RTL Reader v0.4.12 or newer and Native Spread v0.0.113 or newer are required for
