...
Supernote RTL Reader. v0.0.138 is a pre-hardware, exact-firmware candidate. It
...
hooks are executable in the v0.0.138 package. The authoritative current v2
...
`supernote-native-reader-v2-v0.0.138`. Review branches never receive that
credential.
...
requires Supernote RTL Reader v0.4.17 and refuses every other companion
