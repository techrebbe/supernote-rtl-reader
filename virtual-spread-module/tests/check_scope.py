...
for required in (
    ...
    "Invalid or cyclic named destination tree",
...
for required in (
    ...
    "test_oversized_fitr_requires_explicit_fit_normalization",
    "test_named_oversized_fitr_is_normalized_consistently",
    "test_outline_viewport_requires_explicit_page_level_normalization",
    "test_outline_normalization_rejects_out_of_crop_viewport",
    "test_broken_outline_target_requires_explicit_target_discard",
    "test_unsupported_null_outline_semantics_are_not_discarded",
    "test_tiny_link_rect_crop_bleed_is_clipped_deterministically",
    "test_compatibility_policy_flags_require_exact_booleans",
    ...
    "test_standalone_named_destination_is_transformed_and_preserved",
    "test_unsupported_standalone_named_destination_fails_before_publication",
    "test_malformed_raw_named_destination_leaf_fails_before_publication",
    "test_nested_named_destination_tree_is_fully_preserved",
    "test_legacy_named_destination_is_transformed_and_preserved",
    "test_outline_hierarchy_style_order_and_named_destination_survive",
