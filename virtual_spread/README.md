...
geometry. Native module v0.0.21 authenticates each internal link's target-view
...
geometry, malformed or duplicate-key manifest JSON at any nesting level,
...
and sidecar together before opening them with v0.0.21. Native reader callbacks
