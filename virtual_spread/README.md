...
geometry. Native module v0.0.22 authenticates each internal link's target-view
...
and sidecar together before opening them with v0.0.22. Native reader callbacks
